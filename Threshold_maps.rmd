...
The maps below present the HS1 thresholds. The UK ESG needs to agree where we can accept these and where they are not acceptable. In cases where the HS1 thresholds we should in the first instance look at the relative method thresholds.
...
The relative method produces thresholds that are in most cases similar to the HS1 thresholds but sometimes disagree.
